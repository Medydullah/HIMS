                            ...
                            <div class="col-md-12">
                                           ...
                                           <div class="card col-md-10 offset-1 new-employee-wrapper">
                                               ...
                                               <div>
                                                   <h4>
                                                       ...
                                                       Medical Service & Drug price



                                                       <a class="btn btn-sm btn-danger float-right" href="{{ route('health_provider.admin.service.price') }}/">
                               ...
                               <div class="section-divider" style="margin-top: 1em">
                                               ...
                                               <div class="form-group row">
                                                   <label for="drug name" class="col-md-4 col-form-label text-md-right">
                                                       Name</label>
