            ...
            <div class="card col-md-10 offset-1 new-employee-wrapper">
                ...
                <div>
                    <h4>
                        ...
                        <a class="btn btn-sm btn-danger float-right" href="{{ route('hce.pharmacy.table') }}/">
...
<div class="section-divider" style="margin-top: 1em">
                ...
                <div class="form-group row">
                    <label for="price" class="col-md-4 col-form-label text-md-right">Complete Dose Price</label>
